...
const guides: Guide[] = [
  ...
  },
  {
    ...
    title: 'Světoběžník a bobříci',
    subtitle: 'Jak sbírat bobříky a plnit týdenní výzvy',
    color: 'from-emerald-500 to-teal-600',
    steps: [
      { heading: 'Co je Světoběžník?', text: 'Světoběžník je sekce plná výzev, aktivit a zábavy. Najdeš ji v levém menu pod ikonou globusu. Jako první jsou tu Bobříci — týdenní výzvy, za které získáš odznáček.' },
      { heading: 'Co je bobřík?', text: 'Bobřík je výzva, kterou plníš každý den po dobu 7 dní. Každý den uděláš to, co bobřík vyžaduje (např. pomůžeš doma, uděláš někomu radost nebo uklídíš odpadek v přírodě), a klikneš na „Dnes splněno".' },
      { heading: 'Jak začít lovit bobříka?', text: 'V menu klikněte na „Světoběžník". Zobrazí se přehled dostupných bobříků. Klikněte na bobříka, který vás zaujal — otevře se stránka s článkem o tom, proč je bobřík důležitý a jak ho plnit.' },
      { text: 'Na stránce bobříka klikněte na „Začít lovit". Bobřík se aktivuje a objeví se vám widget na hlavním přehledu (dashboardu).' },
      { heading: 'Denní potvrzení', text: 'Každý den, kdy jste splnili podmínku bobříka, klikněte na tlačítko „Dnes splněno" — buď přímo na dashboardu ve widgetu, nebo na stránce bobříka. Jde kliknout jednou za den (od půlnoci). Sledujte, jak se pruh postupu plní.' },
      { heading: 'Splnění bobříka', text: 'Po 7 úspěšných dnech bobřík splníte — gratulujeme! Na stránce se objeví slavnostní hlášení a odznáček vám platí celý rok. Po roce dostanete připomenutí, že je čas bobříka obnovit.' },
      { heading: 'Více bobříků najednou', text: 'Můžete mít aktivních více bobříků zároveň — každý se zobrazí jako samostatná kartička ve widgetu na dashboardu.' },
    ],
    tips: [
      'Buďte k sobě poctiví — bobřík má smysl jen tehdy, když podmínku skutečně splníte. Nikdo jiný to nekontroluje, jen vy sami.',
      'Nevynechejte den — pokud den přeskočíte, postup se neztrácí, ale výzva trvá déle.',
      'Zlatý bobřík: kdo získá všechny dostupné bobříky v daném roce, získá zlatého bobříka!',
    ],
  },
  {
    id: 'community',
